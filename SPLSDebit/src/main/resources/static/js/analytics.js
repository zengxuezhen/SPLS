(function() {
    ...
    var Q = function(a, b, c) {
        ...
        r.history && r.history.replaceState && (M.test(b) || M.test(c)) && (a = y(a, "path"),
        b = d(b, "?"),
        c = d(c, "#"),
    ...
    function W(a, b, c) {
        b.href && (a = T(a, b.href, void 0 === c ? !1 : c),
        q.test(a) && (b.href = a))
    }
    function V(a, b) {
        if (b && b.action) {
...
(function() {
    ...
    var ad = void 0
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j76", "sr=1"],
        b && a.push("_f=" + b),
    ...
    var u = function(a, b, c) {
      ...
      , y = function(a, b, c, d, e) {
        if (!ea(Yd.get(b)) && !$d.get(b)) {
            ...
            c = b + ".js") : J(43);
            if (c && (c && 0 <= c.indexOf("/") || (c = (ad ? ad + "/34" : bd(!1) + "/plugins/ua/") + c),
            d = ae(c),
            a = d.protocol,
            c = M.location.protocol,
            ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d))) {
                if (d = d.url)
                    a = (a = M.querySelector && M.querySelector("script[nonce]") || null) ? a.nonce || a.getAttribute && a.getAttribute("nonce") || "" : "",
                    e ? (e = "",
                    a && Nd.test(a) && (e = ' nonce="' + a + '"'),
                    f.test(d) && M.write("<script" + e + ' src="' + d + '">\x3c/script>')) : (e = M.createElement("script"),
