!function t(e, r, i) {
        ...
        v.prototype = {
            ...
            handleEvent: function(t) {
                ...
                case "DOMNodeInserted":
                    var s, u, i = t.relatedNode, c = t.target;
    ...
    2: [function(t, e, r) {
        ...
        i = t("../core/dimensions/app_dimension"),
        ...
        n = function() {
            ...
            var e;
            return t.prototype.version = "2.1.27",
            ...
            t.prototype.initialCSFields = function(t) {
                ...
                for (i = [],
                e = r = 20; r >= 2; e = --r)
                    i.push(this["setCS" + e] = function(t) {
                        return function(e) {
                            return function(e, r) {
                                var i;
                                return t.app.set((i = {},
            ...
            t.prototype.config = function(t) {
                ...
                for (r in t)
                    n = t[r],
                    r in e && (r = e[r]),
                    "object" == typeof n ? this.apply.apply(this, [r].concat(l.call(n))) : this.apply(r, n);
                i = [];
                for (r in this.options)
                    i.push(window.vds[r] = this.options[r]);
                return i
            }
            ,
            t.prototype.trackPV = function(t, e) {
                ...
                null != (i = this.observer) ? i.pageService.sendPV(null, e) : void 0
            }
            ,
            ...
            t.prototype.initSystemConfig = function(t) {
                ...
                i = t.length; i > r; r++)
                    e = t[r],
                    n.push(this.apply.apply(this, e));
                return n
            }
            ,
        ...
        n = function(t) {
            ...
            e.prototype.setId = function(t) {
                ...
                if (t && window.vds.accountId && this.getId() !== t)
                    ...
                    i = this.gruser.last_sent_cs1(),
                    this.getId() && this.getId() !== t && (r = this.gruser.guid(),
                    a = !1),
                    r === n && o === r && this.gruser.last_sent_cs1() !== t && (r = this.gruser.guid()),
                    this.getId() || (a = !1),
        ...
        n = function(t) {
            ...
            e.prototype.track = function(t) {
                ...
                if (t) {
                    ...
                    for (i = n = 0,
                    o = arguments.length; o > n; i = ++n)
                        e = arguments[i],
                        this.utils.isFunction(e) ? r = e : this.utils.isObject(e) ? a = e : 0 === i ? t = e : s = e;
            ...
            e.prototype._buildTrackMessage = function(t, e, r) {
                ...
                window.vds.appId && (n.appId = window.vds.appId),
                a = o.vaildEventNumber(r),
                a && (n.num = a),
                u = o.vaildVar(e),
                u && (n["var"] = u),
                i = this.gruser.getCs1(),
                i && (n.cs1 = i),
                n.d = window.location.host || window.vds.accountId,
                s = this.utils.query(),
                s.length > 0 && (n.q = s),
                n) : null
            }
    ...
    10: [function(t, e, r) {
        ...
        i = function() {
            ...
            return t.prototype.path = function(t, e) {
                ...
                if (t.tagName) {
                    for (r = new n(t); "body" !== r.name && "html" !== r.name && (i = {
                        x: r.path(),
                        h: r.href,
                    ...
                    l || (r.hasIdx() ? (l = !0,
                    d = r.grIdx) : (C = r.path(),
                    (-1 !== C.indexOf("/dl") || -1 !== C.indexOf("/tr") || -1 !== C.indexOf("/li")) && (l = !0,
                    d = this.index(r.node)))),
                    y = r.node.parentNode,
                    e && "" !== s && (-1 !== u.indexOf(a, r.node.tagName) || r.isContainer()) && (p ? i.obj = h : u.hasAttr(r.node.parentNode, "data-growing-info") && (i.obj = r.node.parentNode.getAttribute("data-growing-info")),
                    i.x = c,
                    o.push(i)),
                    s = m + s,
                    c++,
            ...
            t.prototype.index = function(t) {
                ...
                if (s)
                    ...
                    i = c.length; i > e; e++)
                        if (n = c[e],
                        n.tagName === s.tagName) {
                            if (u.hasAttr(n, "data-growing-idx") && (r = parseInt(n.getAttribute("data-growing-idx"))),
                            n === s)
                                return r;
                            r += 1
                        }
    ...
    12: [function(t, e, r) {
        ...
        s = t("../tools/utils"),
        o = s.detectIE() || 0 / 0,
        n = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g,
        i = function() {
            function t(t) {
                var e, r, i;
                this.node = t,
                ...
                "input" === this.name && s.hasAttr(t, "name") && t.getAttribute("name") ? this.klass = [t.getAttribute("name")] : (r = null != (i = s.getKlassName(t, o)) ? i.replace(n, "").trim() : void 0,
                (null != r ? r.length : void 0) > 0 && (this.klass = r.split(/\s+/).sort()))
            }
            return t.prototype.path = function() {
                var t, e, r, i, n;
                if (i = "/" + this.name,
                null != this.id && (i += "#" + this.id),
                null != this.klass)
                    for (n = this.klass,
                    t = 0,
                    r = n.length; r > t; t++)
    ...
    13: [function(t, e, r) {
        ...
        i = function() {
            function t(t, e, r, i) {
                ...
                this.launcher = r,
                this.TreeMirror = i,
                this.setPSForActionMessage = c(this.setPSForActionMessage, this),
                this.pageChanged = c(this.pageChanged, this),
                this.sendPageCallback = c(this.sendPageCallback, this),
                this.content = {},
                this.pageService = new o(this.sender,this.gruser,this.launcher)
            }
            ...
            t.prototype.setPageGroup = function(t) {
                return this.pageService.setPageGroup(t, function(e) {
                    return function(r) {
                        ...
                        null != (i = e.messagingObserver) ? i.sendPageLoad({
                            pg: t
                        }) : void 0
                    }
                }(this))
                    ...
                    t = {
                        initialize: function(t) {
                            return function(e) {
                                ...
                                return a.e = n,
                                n.length > 0 ? t.sender.send([a]) : void 0
                            }
                        }(this),
            ...
            t.prototype.sendPolicy = function(t) {
                return h.push(t),
                0 > b ? this.sendQueue() : (this.queueTimeout && clearTimeout(this.queueTimeout),
            ...
            t.prototype.idle = function() {
                ...
                this.lastSentTime && (+Date.now() - this.lastSentTime) / h.length > 300
            }
            ,
            ...
            t.prototype.sendQueue = function() {
                return h.length > 0 && +Date.now() - this.lastActionTime < 12e4 && this.sender.send(h),
            ...
            t.prototype.getLeafNodes = function(t, e) {
                ...
                c.push(p)),
                0 === t.childNodes.length && -1 === u.indexOf(y, t.tagName))
                    ;
                else {
                    for (m = t.childNodes,
                    o = 0,
                    d = m.length; d > o; o++)
                        i = m[o],
                        i.leaf || (f = !1),
                        "use" !== i.tagName && (c = c.concat(this.getLeafNodes(i, t.childNodes.length)));
                    if ((-1 !== u.indexOf(v, t.tagName) || f && ((null != (w = t.attributes) ? w.any : void 0) || t.text)) && (t.text || (n = t.dom,
                    t.text = n ? this.info.containerElemContent(n) : u.parentOfLeafText(t)),
                    ...
                    "SPAN" === t.tagName)
                        ...
                        h = b.length; h > s; s++)
                            ...
                            "svg" === i.tagName)
                                ...
                                l = _.length; l > a; a++)
                                    r = _[a],
                                    1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (t.text = r.getAttribute("xlink:href"),
                                    p = this.nodeMessage(t, !1),
                                    c.push(p))
                }
                return c
            ...
            t.prototype.nodeMessage = function(t, e) {
                ...
                n.v = u.processText(t.text),
                "A" === t.tagName && 0 === (null != (o = t.text) ? o.length : void 0) && (n.v = void 0),
                (null != (s = t.text) ? s.length : void 0) > 50 && (n.v = "A" === t.tagName ? u.processText(t.text.slice(0, 50)) : void 0),
                (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (n.h = u.normalizePath(r.href.slice(0, 320)),
                delete t.attributes.href),
                t.idx && (n.idx = t.idx),
                t.obj && (n.obj = t.obj),
                this.appendMessageAttrs(i, n, t)
            }
            ,
            ...
            t.prototype.registerEventListener = function() {
                ...
                f = function(t) {
                    var e;
                    return e = +Date.now() - p.time,
                    e > 1e3 ? clearTimeout(S) : void 0
                }
                ,
                c = function(t, e) {
                    var i;
                    return i = r ? e.touches[0] : e,
                    i["page" + t.toUpperCase()]
                }
                ,
                n = function() {
                    ...
                    return function(r) {
                        ...
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            ...
                            "click" === r.type) {
                                if (-1 !== u.indexOf(e, d))
                                    return;
                                if ("INPUT" === d && -1 === u.indexOf(w, h.type))
                                    return;
                                if (-1 === u.indexOf(y, d) && !t.info.depthInside(h, 4))
                                    return
                            }
                            ...
                            c = "snapshot" === r.type,
                            c && (r.type = "click"),
                            o = t.compute(c ? "click" : r.type, h),
                            t.appendElemAttrs(o, c, h, i),
                            o.x = i.xpath,
                            i.obj && (o.obj = i.obj),
                            i.idx ? o.idx = i.idx : (-1 !== o.x.indexOf("/dl") || -1 !== o.x.indexOf("/tr") || -1 !== o.x.indexOf("/li")) && (o.idx = t.info.index(h)),
                            s.e = 0 === i.containerMessage.length ? [o] : -1 !== u.indexOf(v, i.pnode.tagName) && t.info.onlyContainsChildren(i.pnode, g) ? i.containerMessage : [o].concat(i.containerMessage),
                            c ? t.snapshotCallback(r, s) : t.sender.send([s])
                        }
                    }
                }(this);
                for (o in a)
            ...
            t.prototype.compute = function(t, e) {
                ...
                if (i = {},
                O = e.tagName,
                "IMG" === O ? (null != (_ = e.src) ? _.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (i.h = e.src) : u.hasAttr(e, "href") && (n = e.getAttribute("href"),
                n && 0 !== n.indexOf("javascript") && (i.h = u.normalizePath(n.slice(0, 320)))),
                u.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0)
                    i.v = e.getAttribute("data-growing-title");
                else if (u.hasAttr(e, "title") && e.getAttribute("title").length > 0)
                    i.v = u.processText(e.getAttribute("title"));
                else if ("click" === t)
                    if (this.info.isLeaf(e))
                        if ("IMG" === O)
                            e.alt ? i.v = e.alt : i.h && (a = i.h.split("?")[0],
                            s = a.split("/"),
                            s.length > 0 && (i.v = s[s.length - 1]));
                        else if ("INPUT" === O && -1 !== u.indexOf(w, e.type))
                            i.v = u.processText(e.value);
                        else if ("svg" === O)
                            for (S = e.childNodes,
                            o = 0,
                            y = S.length; y > o; o++)
                                r = S[o],
                                1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (i.v = r.getAttribute("xlink:href"));
                        else
                            I = "",
                            null != e.textContent ? I = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (I = e.innerText.replace(/[\n \t]+/g, " ").trim()),
                            I.length > 0 && (I.length < 50 ? i.v = u.processText(I) : "A" === O && (i.v = u.processText(I.slice(0, 50))));
                    else
                        -1 !== u.indexOf(v, O) ? i.v = this.info.containerElemContent(e) : this.info.isParentOfLeaf(e) && (i.v = u.parentOfLeafText(e));
                else if ("change" === t)
                    "TEXTAREA" !== O && ("INPUT" === O ? -1 !== u.indexOf(f, e.type) ? (i.v = u.processText(e.value),
                    h = e.parentNode,
                    "LABEL" === h.tagName ? d = h : "BODY" !== h.tagName && (h = h.parentNode,
                    "LABEL" === h.tagName ? d = h : e.id && (m = h.getElementsByTagName("label"),
                    function() {
                        var t, r, i;
                        for (i = [],
                        t = 0,
                    ...
                    null != d && (l = this.info.containerElemContent(d),
                    (null != l ? l.length : void 0) > 0 && (i.obj = l + " (" + e.checked + ")"))) : "password" !== e.type && (u.hasAttr(e, "growing-track") || u.hasAttr(e, "data-growing-track")) && (i.v = u.processText(e.value)) : "SELECT" === O && (i.v = u.processText(e.value),
                    1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (i.obj = e.selectedOptions[0].label)));
                else if ("submit" === t)
                    for (C = e.getElementsByTagName("input"),
                    p = 0,
                    b = C.length; b > p; p++)
                        c = C[p],
                        ("search" === c.type || "text" === c.type && ("q" === c.id || -1 !== c.id.indexOf("search") || -1 !== c.className.indexOf("search") || "q" === c.name || -1 !== c.name.indexOf("search"))) && (i.x = this.info.path(c).xpath,
                        i.v = u.processText(c.value.trim()));
                return i
            }
            ,
            t.prototype.registerCircleHandler = function() {
                ...
                try {
                    if (!this.messagingObserver)
                        return this.messagingObserver = new n,
            ...
            t.prototype.registerHistoryHandler = function() {
                ...
                null != t && (this.prevUrl = u.getDocumentReferrer(),
                "function" == typeof Object.defineProperty && Object.defineProperty(document, "referrer", {
                    get: function(t) {
                        return function() {
                            return t.prevUrl
                        }
                ...
                window.vds.hashtag ? u.bind(window, "hashchange", this.pageChanged, !0) : void 0
            }
            ,
                ...
                return u.bind(window, "message", function(t) {
                    return function(e) {
                        ...
                        try {
                            ...
                            "update-global-env" === n && (window.grCircleEnv = r.add_on_grSource),
                            n) {
            ...
            t.prototype.loadPluginOuter = function(t) {
                ...
                e.charset = "UTF-8",
                e.src = -1 === s.indexOf("http") ? "//" + s + "/assets/javascripts/outer-circle-plugin.js" : s + "/assets/javascripts/outer-circle-plugin.js",
                document.head.appendChild(e),
                r = document.createElement("link"),
                r.rel = "stylesheet",
                r.href = -1 === s.indexOf("http") ? "//" + s + "/assets/stylesheets/outer-circle-plugin.css" : s + "/assets/stylesheets/outer-circle-plugin.css",
            ...
            t.prototype.observe = function() {
                ...
                u.bind(window, "beforeunload", function(t) {
                    return function(e) {
                        var r, i;
                ...
                a && u.bind(window, "pagehide", function(t) {
                    return function(e) {
                        var r, i;
                        if (t.queueTimeout && t.sendQueue(),
                        i = +Date.now(),
                ...
                u.bind(window, "unload", function(t) {
                    return function(t) {
                        var e;
    ...
    14: [function(t, e, r) {
        ...
        n = ["load-plugin", "register-iframe", "circle-mode", "browse-mode", "page-load", "circle-load"],
        i = function() {
            function t() {
            ...
            return t.prototype.bindEvents = function() {
                return s.bind(window, "message", function(t) {
                    return function(e) {
                        var r, i, n, a;
                        if (r = e.data,
                        r.ai === window.vds.accountId && (i = r.mode || r.circleMode,
                        t.isSdkEvent(i) && (!r.fsna || "sdk" === r.fsna))) {
            ...
            t.prototype.sendPageLoad = function(t) {
                var e, r, i, n, o;
                null == t && (t = null),
                n = (null != (i = window.vds) ? i.pathCaseSensitive : void 0) ? window.location.toString() : window.location.toString().toLowerCase();
                for (e in vds)
                    o = vds[e],
            ...
            t.prototype.loadPluginInner = function() {
                ...
                return this.pluginLoaded || (e = document.createElement("script"),
                e.type = "text/javascript",
                e.charset = "UTF-8",
                e.src = -1 === this.allowOrigin.indexOf("http") ? "//" + this.allowOrigin + "/assets/javascripts/" + t + ".js" : this.allowOrigin + "/assets/javascripts/" + t + ".js",
                document.head.appendChild(e),
                window._gr_support_circle_pop_out === !0) ? void 0 : (r = document.createElement("link"),
                r.rel = "stylesheet",
                r.href = -1 === this.allowOrigin.indexOf("http") ? "//" + this.allowOrigin + "/assets/stylesheets/circle-plugin.css" : this.allowOrigin + "/assets/stylesheets/circle-plugin.css",
                document.head.appendChild(r))
            }
            ,
        ...
        i = function() {
            ...
            t.prototype.sendPV = function(t, e) {
                ...
                if (this.options.addPreProps || this.options.gioId)
                    for (i in this.preProperties)
                        null == (r = this.properties)[i] && (r[i] = this.preProperties[i]);
            ...
            t.prototype.sendPVOnSidChanged = function(t) {
                ...
                i = e[0],
                r = e[1],
                this.gruser.lastSessionId !== i ? (i || (i = this.gruser.guid(),
                this.gruser.resetUserId()),
                this.gruser.updateSessionId(i, !1),
                this.sendPV({
                    sendVisit: !0,
                    useNewTime: !0
                }, t)) : void 0
    ...
    18: [function(t, e, r) {
        ...
        s = {
            bind: function(t, e, r, i) {
                return null == i && (i = !1),
                null != document.addEventListener ? t.addEventListener(e, r, i) : null != document.attachEvent ? t.attachEvent("on" + e, function() {
                    var e;
            ...
            functionDeserialization: function(t) {
                var e, r, i;
                return "string" == typeof t && (i = /function[^\(]*\(([^\)]*)\)[^\{]*{([^\}]*)\}/,
                r = t.match(i)) ? (e = r[1].split(",").map(arg(function() {
            ...
            parentOfLeafText: function(t) {
                ...
                o = a.length; o > n; n++)
                    ...
                    r.length > 0 && (i += r + " "));
                return i = i.replace(/[\n \t]+/g, " ").trim(),
                i.length > 0 && i.length < 50 ? s.processText(i) : void 0
            },
            ...
            detectIE: function() {
                ...
                window.ActiveXObject && (e = n.indexOf("MSIE "),
                e > 0) ? parseInt(n.substring(e + 5, n.indexOf(".", e)), 10) : (i = n.indexOf("Trident/"),
                i > 0 ? (r = n.indexOf("rv:"),
                parseInt(n.substring(r + 3, n.indexOf(".", r)), 10)) : (t = n.indexOf("Edge/"),
                t > 0 ? parseInt(n.substring(t + 5, n.indexOf(".", t)), 10) : !1))
            },
            hashCode: function(t) {
                var e, r, i;
                if (null == t && (t = ""),
            ...
            getDocumentReferrer: function(t) {
                var e, r;
                return r = t ? t : document.referrer,
            ...
            vaildVar: function(t) {
                ...
                null != t)
                    for (r in t)
                        ...
                        null != n && "string" == typeof n && n.constructor === String && (n = n.length <= 1e3 ? n : n.slice(0, 1e3)),
                        i[e] = n,
                        this.getOwnPropertyNames(i).length >= 100)
                            return i;
                return i
            },
        ...
        var i = /^(\.br\.|\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/
          , n = {
            ...
            setItem: function(t, e, r, i, n, o) {
                ...
                return document.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + s + (n ? "; domain=" + n : "") + (i ? "; path=" + i : "") + (o ? "; secure" : ""),
                !0
            },
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep)
                        ...
                        r = 0; o > r; r += 1)
                            ...
                            n = str(i, u),
                            n && s.push(quote(i) + (gap ? ": " : ":") + n));
                    else
                        for (i in u)
                            Object.prototype.hasOwnProperty.call(u, i) && (n = str(i, u),
                            n && s.push(quote(i) + (gap ? ": " : ":") + n));
                    return n = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}",
                    gap = a,
                    n
            ...
            "function" != typeof JSON.parse && (JSON.parse = function(text, reviver) {
                function walk(t, e) {
                    ...
                    if (n && "object" == typeof n)
                        for (r in n)
                            Object.prototype.hasOwnProperty.call(n, r) && (i = walk(n, r),
                            void 0 !== i ? n[r] = i : delete n[r]);
            ...
            var t = String.fromCharCode
              ...
              , r = {
                ...
                _compress: function(t, e, r) {
                    if (null == t)
                        return "";
                    var i, n, o, s = {}, a = {}, u = "", c = "", d = "", h = 2, l = 3, p = 2, f = [], g = 0, v = 0;
        ...
        var h = function() {
          ...
          , f = function() {
            ...
            t.prototype.visitNode = function(t, e) {
                if (!this.visited.has(t)) {
                    ...
                    var r = this.treeChanges.get(t)
                      , i = e;
                    if ((r && r.childList || void 0 == i) && (i = this.treeChanges.reachabilityChange(t)),
                    i !== c.STAYED_OUT) {
                        ...
                        i === c.ENTERED)
                            ...
                            var n = c.STAYED_IN;
                            r && r.childList && (r.oldParentNode !== t.parentNode ? (n = c.REPARENTED,
                            this.ensureHasOldPreviousSiblingIfNeeded(t)) : this.calcReordered && this.wasReordered(t) && (n = c.REORDERED)),
            ...
            t.prototype.ensureHasOldPreviousSiblingIfNeeded = function(t) {
                if (this.calcOldPreviousSibling) {
                    ...
                    i || (i = new l,
                    this.childListChangeMap.set(e, i)),
                    i.oldPrevious.has(t) || i.oldPrevious.set(t, t.previousSibling)
                }
            }
            ,
                    ...
                    if (u.attributes && c.STAYED_IN === this.treeChanges.reachabilityChange(a) && c.STAYED_IN === this.matchabilityChange(a))
                        for (var d = a, h = u.getAttributeNamesMutated(), l = 0; l < h.length; l++) {
                            ...
                            if (!e || e[n] || u.isCaseInsensitive && r[n]) {
                                ...
                                p !== d.getAttribute(n) && (r && u.isCaseInsensitive && (n = r[n]),
                                o[n] = o[n] || [],
                                o[n].push(d))
                            }
                        }
                    ...
                    for (var e = 0; e < this.mutations.length; e++) {
                        ...
                        if ("childList" == r.type && (this.treeChanges.reachabilityChange(r.target) === c.STAYED_IN || this.calcOldPreviousSibling)) {
                            for (var i = this.getChildlistChange(r.target), n = r.previousSibling, o = 0; o < r.removedNodes.length; o++) {
                                ...
                                t(s, n),
                                i.added.has(s) ? i.added.remove(s) : (i.removed.set(s, !0),
                                i.maybeMoved.remove(s)),
                                n = s
                            }
                            t(r.nextSibling, n);
                            for (var o = 0; o < r.addedNodes.length; o++) {
                                var s = r.addedNodes[o];
                                i.removed.has(s) ? (i.removed.remove(s),
            ...
            t.prototype.wasReordered = function(t) {
                ...
                function r(t) {
                    ...
                    if (void 0 !== i)
                        return i;
                    for (i = s.oldPrevious.get(t); i && (s.removed.has(i) || e(i)); )
                        i = r(i);
                    return void 0 === i && (i = t.previousSibling),
                    u.set(t, i),
                    i
                }
                function i(t) {
          ...
          , g = function() {
            function t(t, e) {
                ...
                e.all || e.attribute || e.attributeList) {
                    ...
                    e.attribute ? this.valueChanged = n[e.attribute] || [] : (this.attributeChanged = n,
          ...
          , y = function() {
            ...
            t.parseSelectors = function(e) {
                function r() {
                    n && (o && (n.qualifiers.push(o),
                    o = void 0),
                    a.push(n)),
                    n = new t
                }
                function i() {
                    o && n.qualifiers.push(o),
                    o = new w
                }
          ...
          , _ = function() {
            ...
            t.validateOptions = function(e) {
                ...
                for (var i = {
                    ...
                    if (a.all) {
                        ...
                        if (u.elementFilter = y.parseSelectors("*[" + u.attribute + "]"),
            ...
            t.prototype.createSummaries = function(t) {
                if (!t || !t.length)
                    return [];
                for (var e = new f(this.root,t,this.elementFilter,this.calcReordered,this.options.oldPreviousSibling), r = [], i = 0; i < this.options.queries.length; i++)
                    r.push(new g(e,this.options.queries[i]));
                return r
            }
            ,
          ...
          , c = function() {
            ...
            t.prototype.serializeNode = function(t, e, r, c) {
                ...
                case 1:
                    ...
                    w.childNodes.length > 0) {
                        ...
                        var _, S, C = 0, O = -1 !== u.indexOf(w.tagName);
                        if (O)
                        ...
                        for (var N = w.firstChild; N; N = N.nextSibling) {
                            ...
                            S = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1,
                            1 === N.nodeType) {
                                if (1 === i[N.tagName]) {
                                    b = !1;
                                    continue
                                ...
                                if (N.hasAttribute("growing-ignore") || N.hasAttribute("data-growing-ignore"))
                                    continue;
                                if (O && -1 !== a.indexOf(N.tagName) && (b = !1,
                                !N.children || 0 === N.children.length))
                                    continue;
                                -1 !== n.indexOf(N.tagName) && (C += 1,
                                S = C),
                                N.hasAttribute("data-growing-idx") && (C = parseInt(N.getAttribute("data-growing-idx")),
                                S = C),
            ...
            t.prototype.serializeAddedAndMoved = function(t, e, r) {
                ...
                return c.forEach(function(t) {
                    for (var e = void 0, r = t; r && "BODY" !== r.tagName && -1 === n.indexOf(r.tagName); )
                        r = r.parentNode;
                    if (r && "BODY" !== r.tagName) {
                        var i = r.parentNode;
                        if (null == i)
    ...
    26: [function(t, e, r) {
        ...
        n = function(t) {
            ...
            e.prototype.vid = function() {
                ...
                this.userId ? this.cookie.setItem("gr_user_id", this.userId, this.duration10year, "/", this.cookieDomain()) : (this.userId = this.guid(),
                this.cookie.setItem("gr_user_id", this.userId, this.duration10year, "/", this.cookieDomain())),
                this.userId)
            }
            ,
            ...
            e.prototype.updateCS1 = function(t, e) {
                ...
                t ? (this.clearCs1(),
                this.cookie.setItem(r + "_gr_last_sent_sid_with_cs1", e, this.duration30min, "/", this.cookieDomain()),
                this.cookie.setItem(r + "_gr_last_sent_cs1", t, this.duration10year, "/", this.cookieDomain()),
                this.cookie.setItem(r + "_gr_cs1", t, this.duration10year, "/", this.cookieDomain())) : void 0
            }
            ,
            e.prototype.clearCs1 = function() {
                var t, e;
                return e = this.cookieDomain(),
            ...
            e.prototype.currentSessionId = function(t) {
                ...
                r = "true" === this.cookie.getItem(t + "_gr_session_id_" + i),
                i && i.indexOf("_") >= 0 && (e = i.split("_"),
                i = e[0],
                r = e[1],
                r = "true" === r,
                this.updateSessionId(i, r)),
                i && "null" === i && (i = "",
                r = !1),
                [i, r]
            }
            ...
            e.prototype.updateSessionId = function(t, e, r) {
                var i;
                return this.lastSessionId !== t && this.visitorVar && (i = !0),
                t ? (r || (r = window.vds.accountId),
                this.lastUpdated = +Date.now(),
                this.lastSessionId = t,
                this.updateSessionIdSendStatus(e, t, r),
                this.cookie.setItem(r + "_gr_session_id", t, this.duration30min, "/", this.cookieDomain()),
                i && this.currentSessionId()[0] ? window.gio("visitor.set", this.visitorVar) : void 0) : (console && console.error("sid shoud not be empty!"),
            ...
            e.prototype.updateSessionIdSendStatus = function(t, e, r) {
                var i, n, o, s;
                for (null == r && (r = window.vds.accountId),
                o = this.cookie.keys(),
                i = 0,
                s = o.length; s > i; i++)
                    if (n = o[i],
                    n.match(/.*_gr_session_id_/) && n.slice(n.lastIndexOf("_") + 1) !== e) {
    ...
    27: [function(t, e, r) {
        ...
        n = t("./observer/dom_observer"),
        s = t("./sender"),
        i = t("../core/base_launcher"),
        u = t("./info/dom_info"),
        d = t("../core/tools/utils"),
        a = d.detectIE() || 0 / 0,
        c = void 0,
        ...
        o = function(t) {
            function e() {
                ...
                this.observer = new n(this.sender,this.user,this,c)
            }
            return l(e, t),
    ...
    28: [function(t, e, r) {
        ...
        !window._disable_js_vds && ("boolean" != typeof window.webViewRequestSend || window.webViewRequestSend || !window._vds_ios && !window._vds_bridge) && (window._vds_hybrid || window._gr_ignore_local_rule || -1 === h.indexOf(["", "localhost", "127.0.0.1"], window.location.hostname))) {
            ...
            window.gio = function() {
                ...
                i = window.gioGlobalArray,
                o = [],
                e = 0,
                r = i.length; r > e; e++)
                    t = i[e],
                    o.push("init" === (n = arguments[0]) || "send" === n ? "web" === t.platform ? t.apply(null, arguments) : void 0 : t.apply(null, arguments));
                return o
            }
            ,
            ...
            window._vds = {
                push: function() {
                    var t, e, r, i, n;
                    for (i = window.gioGlobalArray,
                    n = [],
                    e = 0,
                    r = i.length; r > e; e++)
                        t = i[e],
                        n.push(t.push.apply(t, arguments));
                    return n
                },
                track: function() {
                    var t, e, r, i, n;
                    ...
                    r = i.length; r > e; e++)
                        t = i[e],
                        n.push(t.track.apply(t, arguments));
                    return n
                }
            }
        }
    ...
    29: [function(t, e, r) {
        ...
        i = t("../../core/observer/dom_observer"),
        s = t("../info/dom_info"),
            ...
            t._fetchServerSetting = function() {
                ...
                s.sendRequest(e, function(t) {
                    return function(t) {
                        ...
                        i.set("gr_imp_" + s.hashCode(window.vds.accountId), e),
                        window.vds.imp &= e,
    ...
    31: [function(t, e, r) {
        ...
        "ArrayBufferView"in window || (-1 !== d.indexOf("Android") ? i = !1 : -1 !== d.indexOf("CPU OS ") ? -1 !== d.indexOf("CPU OS 6_") ? i = !1 : -1 !== d.indexOf("CPU OS 5_") ? i = !1 : -1 !== d.indexOf("CPU OS 4_") ? i = !1 : -1 !== d.indexOf("CPU OS 3_") && (i = !1) : -1 !== d.indexOf("CPU iPhone OS ") ? -1 !== d.indexOf("iPhone OS 6_") ? i = !1 : -1 !== d.indexOf("iPhone OS 5_") ? i = !1 : -1 !== d.indexOf("iPhone OS 4_") && (i = !1) : -1 !== d.indexOf("Intel Mac OS X") && (-1 !== d.indexOf("Mac OS X 10_6") ? i = !1 : -1 !== d.indexOf("Mac OS X 10_7") && (i = !1)))),
        n = function() {
            function t(t, e) {
                this.user = t,
                this.callback = e,
                this.setListener = l(this.setListener, this),
                this.dispathMessage2Listener = l(this.dispathMessage2Listener, this),
                this.dispatchEvents = l(this.dispatchEvents, this),
                this.imgSendClear = l(this.imgSendClear, this),
                this.addRealTimeMessageCallBack = l(this.addRealTimeMessageCallBack, this),
            ...
            t.prototype.send = function(t, e) {
                var r, i, n, o, c, d, h;
                if (null == e && (e = "action"),
                !window.vds.dataCollect && !window.grBlind && ("boolean" != typeof window.webViewRequestSend || window.webViewRequestSend || !window._vds_ios && !window._vds_bridge))
                    try {
                        if (h = "pv" === e && 2 === t.length ? t[0].s : "",
                        r = "undefined" == typeof Uint8Array || null === Uint8Array || a ? window.XMLHttpRequest && 7 !== s && !a ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)),
                        ...
                        this.typeListReceivedValid.length >= 0 && this.setRealTimeMessageCallBack)
                            ...
                            o = t.length; o > n; n++)
                                c = t[n],
                                d = c.t,
                                p.call(this.typeListReceivedValid, d) >= 0 && this.setRealTimeMessageCallBack(c);
            ...
            t.prototype.addRealTimeMessageCallBack = function(t, e) {
                ...
                try {
                    if (Array.isArray(t))
                        ...
                        o = t.length; o > n; n++)
                            i = t[n],
                            p.call(this.typeListAccepted, i) >= 0 && this.typeListReceivedValid.push(i);
                    else {
                        if (s = t.toString(),
            ...
            t.prototype.sendRemote = function(t, n, o) {
                ...
                window.XMLHttpRequest && 7 !== s && !a ? (u = new XMLHttpRequest,
                "withCredentials"in u ? (u.open("POST", d + "?stm=" + +Date.now(), !0),
                u.withCredentials = !0,
                u.onreadystatechange = function(t) {
                    return function() {
                        return 4 === u.readyState && ("" !== o && (t.sendVisitTimeout -= 300),
                        t.removeAjax(u),
                        window.grWaitTime = +Date.now() + 10,
                        o && "" !== o && 200 === u.status) ? t.user.updateSessionIdSendStatus(!0, o) : void 0
                    }
                }(this),
                u.send("undefined" != typeof ArrayBuffer && null !== ArrayBuffer ? i ? t : t.buffer : t),
                e.push(u)) : "undefined" != typeof XDomainRequest && (u = new XDomainRequest,
                ...
                ,
                u.send(t),
                r.push(u))) : ("http:" === document.location.protocol && (d = d.replace("https://", "http://")),
            ...
            t.prototype.imgSend = function(t, e) {
                var i;
                return i = document.createElement("img"),
                i.width = 1,
                i.height = 1,
                i.onload = function(t) {
                    return function() {
