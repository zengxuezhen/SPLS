...
@Controller
public class AlipayDataDataserviceBillDownloadurlQueryController {
	
    @RequestMapping(value="/alipayDataDataserviceBillDownloadurlQuery.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayDataDataserviceBillDownloadurlQuery";
        
    }

    @RequestMapping(value="/alipayDataDataserviceBillDownloadurlQuery.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayDataDataserviceBillDownloadurlQueryModel alipayModel){
