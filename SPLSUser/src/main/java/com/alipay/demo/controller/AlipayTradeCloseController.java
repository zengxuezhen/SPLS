...
@Controller
public class AlipayTradeCloseController {
	
    @RequestMapping(value="/alipayTradeClose.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeClose";
        
    }

    @RequestMapping(value="/alipayTradeClose.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeCloseModel alipayModel){
