...
@Controller
public class AlipayTradeFastpayRefundQueryController {
	
    @RequestMapping(value="/alipayTradeFastpayRefundQuery.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeFastpayRefundQuery";
        
    }

    @RequestMapping(value="/alipayTradeFastpayRefundQuery.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeFastpayRefundQueryModel alipayModel){
