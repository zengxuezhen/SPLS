...
public class AlipayTradeRefundController {
    ...
    @RequestMapping(value="/alipayTradeRefund.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeRefund";
        
    }

    @RequestMapping(value="/alipayTradeRefund.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeRefundModel alipayModel){
